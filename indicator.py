...
"""
indicator_sonos_power_peavey:
  module: indicator
  class: indicator

  hassio_namespace: cv_primary
  mqtt_namespace: cv_mqtt
  conditons_or:
    light.pool @ cv_primary: !'off'
    light.spa @ cv_primary: !'off'
  indicators:
    'i2mqtt4/outside/sunroom/kp1/set/6': 'ON'
    'i2mqtt4/outside/patio/kp2/set/6': 'ON'
    'i2mqtt4/outside/bbq/kp/set/6': 'ON'
"""
